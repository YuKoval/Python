...
result_m_exp = math.pow(item_2, item_1)
result_m_exp = math.pow(10,11)
print(result_m_exp)
...
result_s_root = item_1 ** 0.5       # Любое число, возведенное в степень 0.5, дает нам квадратный корень из этого числа
print(result_s_root)
...
# Pеализация через арифметические действия с присваиванием.
...
print("item_3 =",item_3)
  ...
  # 38. Умножить item_3 на 3 с присвоением. 39. Вывести item_3 в консоль
item_3 = item_3 * 3
print("item_3 =",item_3)

  # 40. Разделить item_3 на 2 с присвоением. 41. Вывести item_3 в консоль
item_3 = item_3 / 2
print('item_3 =', item_3)

  # 42. Возвести в степень 2 item_3 с присвоением. 43. Вывести item_3 в консоль
item_3 = item_3 ** 2
print('item_3 =', item_3)

  # 44. Найти квадратный корень item_3 с присвоением. 45. Вывести item_3 в консоль
item_3 = item_3 ** 0.5
print("item_3 =",item_3)

  # 46. Присвоить остаток от деления item_347. Вывести item_3 в консоль
...
b_item_f = False
  ...
  # 50. Создать переменную b_item_relult_sum и присвоить сумму b_item_t и b_item_f. 51. Вывести b_item_relult_sum в консоль
b_item_relult_sum = b_item_t + b_item_f
print(b_item_relult_sum)

  # 52. Создать переменную b_item_relult_subtr и присвоить разницу b_item_t и b_item_f. 53. Вывести b_item_relult_subtr в консоль.
b_item_relult_subtr = b_item_t - b_item_f
print(b_item_relult_subtr)


  # 54. Создать переменную b_item_relult_multi и присвоить умножение b_item_t и b_item_f. 55. Вывести b_item_relult_multi в консоль.
b_item_relult_multi = b_item_t * b_item_f
print(b_item_relult_multi)

   # 56. Создать переменную b_item_relult_division и присвоить деление b_item_t и b_item_f. 57. Вывести b_item_relult_division в консоль. (Получить ошибку)
b_item_relult_division = b_item_t / b_item_f
print(b_item_relult_division)

  # 58. Создать переменную b_item_1_int и присвоить явное приведение b_item_t к int. 59. Вывести b_item_1_int в консоль
b_item_1_int = int(b_item_t)
print(b_item_1_int)

  # 60. Создать переменную b_item_2_int и присвоить явное приведение b_item_2 к int. 61. Вывести b_item_2_int в консоль
